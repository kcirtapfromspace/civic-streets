      ...
      <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] ring-1 ring-black/[0.04] p-3.5 flex flex-col gap-3 min-w-[200px]">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-[11px] text-gray-700">Heatmap</span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
            ...
            />
            <span className="text-[11px] text-gray-700">Crash Points</span>
          </label>
        </div>
          ...
          <div className="flex flex-col gap-1.5">
            {ALL_MODES.map((mode) => (
              <label key={mode} className="flex items-center gap-2 cursor-pointer group">
                ...
                />
                <span className="flex items-center gap-1.5 text-[11px] text-gray-700 group-hover:text-gray-900">
                  <span
