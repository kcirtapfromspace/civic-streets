...
function PageHeader({ streetName }: { streetName: string }) {
  return (
    <View style={styles.header}>
      ...
      <Text style={styles.headerDate}>Street Copilot</Text>
    </View>
  );
}
...
function PageFooter({ pageLabel }: { pageLabel: string }) {
  return (
    <View style={styles.footer} fixed>
      <Text style={styles.footerText}>Generated by Street Copilot</Text>
